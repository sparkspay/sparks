...
QT_TRANSLATE_NOOP("sparks-core", "Accept connections from outside (default: 1 if no -proxy or -connect)"),
...
QT_TRANSLATE_NOOP("sparks-core", "Create up to N inputs of each denominated amount (%u-%u, default: %u)"),
QT_TRANSLATE_NOOP("sparks-core", "Debugging/Testing options:"),
QT_TRANSLATE_NOOP("sparks-core", "Disable governance validation (0-1, default: %u)"),
...
QT_TRANSLATE_NOOP("sparks-core", "Error loading wallet %s. Duplicate -wallet filename specified."),
...
QT_TRANSLATE_NOOP("sparks-core", "Send reject messages per BIP61 (default: %u)"),
...
QT_TRANSLATE_NOOP("sparks-core", "Socket events mode, which must be one of: %s (default: %s)"),
...
QT_TRANSLATE_NOOP("sparks-core", "Start PrivateSend automatically (0-1, default: %u)"),
...
QT_TRANSLATE_NOOP("sparks-core", "Sync mempool from other nodes on start (default: %u)"),
...
QT_TRANSLATE_NOOP("sparks-core", "Target PrivateSend balance (%u-%u, default: %u)"),
