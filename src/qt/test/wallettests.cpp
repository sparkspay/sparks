...
//
//     QT_QPA_PLATFORM=xcb     src/qt/test/test_sparks-qt  # Linux
//     QT_QPA_PLATFORM=windows src/qt/test/test_sparks-qt  # Windows
//     QT_QPA_PLATFORM=cocoa   src/qt/test/test_sparks-qt  # macOS
void TestGUI(interfaces::Node& node)
{
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(2).indexOf(QString("URI: sparks:")) != -1);
