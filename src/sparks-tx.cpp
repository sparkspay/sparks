...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s sparks-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  sparks-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded sparks transaction") + "\n" +
              "  sparks-tx [options] -create [commands]   " + _("Create hex-encoded sparks transaction") + "\n" +
              "\n";
