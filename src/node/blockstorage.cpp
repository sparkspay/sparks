...
bool ReadBlockFromDisk(CBlock& block, const FlatFilePos& pos, const Consensus::Params& consensusParams)
{
    ...
    // Check the header
    if (!CheckProofOfWork(block.GetHash(GetBlockAlgo(consensusParams)), block.nBits, consensusParams)) {
...
bool ReadBlockFromDisk(CBlock& block, const CBlockIndex* pindex, const Consensus::Params& consensusParams)
{
    ...
    if (block.GetHash(GetBlockAlgo(consensusParams)) != pindex->GetBlockHash()) {
        return error("ReadBlockFromDisk(CBlock&, CBlockIndex*): GetHash(Consensus::Params&) doesn't match index for %s at %s",
