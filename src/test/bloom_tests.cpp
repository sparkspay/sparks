...
BOOST_AUTO_TEST_CASE(merkle_block_1)
{
    ...
    BOOST_CHECK_EQUAL(merkleBlock.header.GetHash(consensusParams).GetHex(), block.GetHash(consensusParams).GetHex());
    ...
    BOOST_CHECK(merkleBlock.header.GetHash(consensusParams) == block.GetHash(consensusParams));
