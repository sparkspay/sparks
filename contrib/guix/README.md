# Bootstrappable Sparks Core Builds

This directory contains the files necessary to perform bootstrappable Sparks
Core builds.
...
To build Sparks Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      Sparks Core version being built.
...
```
env DETACHED_SIGS_REPO=<path/to/sparks-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/sparkspay/guix.sigs).
...
[guix-docker]: https://github.com/sparkspay/sparks/tree/master/contrib/guix/Dockerfile
