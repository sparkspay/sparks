...
WALLET_TOOL=${WALLET_TOOL:-$BINDIR/sparks-wallet}
...
# This gets autodetected fine for sparksd if --version-string is not set,
# but has different outcomes for sparks-qt and sparks-cli.
