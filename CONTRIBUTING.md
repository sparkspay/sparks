Contributing to Sparks Core
============================

The Sparks Core project operates an open contributor model where anyone is
welcome to contribute towards development in the form of peer review, testing
and patches. This document explains the practical process and guidelines for
contributing.

First, in terms of structure, there is no particular concept of "Sparks Core
...
Before you start contributing, familiarize yourself with the Sparks Core build
system and tests. Refer to the documentation in the repository on how to build
Sparks Core and how to run the unit and functional tests.

There are many open issues of varying difficulty waiting to be fixed.
If you're looking for somewhere to start contributing, check out the
[good first issue](https://github.com/sparkspay/sparks/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list.
...
Most communication about Sparks Core development happens on Discord Server.
...
fork of Sparks Core copies the merge. Instead, make any username mentions in a
subsequent comment to the PR.

### Translation changes

Note that translations should not be submitted as pull requests. Please see
[Translation Process](https://github.com/sparkspay/sparks/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Sparks Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Sparks
Network Protocol consensus changes.

Whether a pull request is merged into Sparks Core rests with the project merge
...
Patches that change Sparks consensus rules are considerably more involved than
...
Where a patch set proposes to change the Sparks consensus, it must have been
...
The project leader is the release manager for each Sparks Core release.
