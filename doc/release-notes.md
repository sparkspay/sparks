...
See detailed [set of changes](https://github.com/sparkspay/sparks/compare/v0.13.2.0...sparkspay:v0.13.3.0).

### Backports

- [`575cafc01`](https://github.com/sparkspay/sparks/commit/575cafc01) Do not skip pushing of vMatch and vHashes in CMerkleBlock (#2826)
- [`8c58799d8`](https://github.com/sparkspay/sparks/commit/8c58799d8) There can be no two votes which differ by the outcome only (#2819)
- [`66c2f3953`](https://github.com/sparkspay/sparks/commit/66c2f3953) Fix vote ratecheck (#2813)
- [`b52d0ad19`](https://github.com/sparkspay/sparks/commit/b52d0ad19) Fix revoke reason check for ProUpRevTx (#2787)
- [`35914e084`](https://github.com/sparkspay/sparks/commit/35914e084) Skip mempool.dat when wallet is starting in "zap" mode (#2782)
- [`46d875100`](https://github.com/sparkspay/sparks/commit/46d875100) Disable in-wallet miner for win/macos Travis/Gitian builds (#2778)
...
- [v0.13.2.0](https://github.com/sparkspay/sparks/blob/master/doc/release-notes/sparks/release-notes-0.13.2.0.md) released Mar/15/2019
- [v0.13.1.0](https://github.com/sparkspay/sparks/blob/master/doc/release-notes/sparks/release-notes-0.13.1.0.md) released Feb/9/2019
- [v0.13.0.0](https://github.com/sparkspay/sparks/blob/master/doc/release-notes/sparks/release-notes-0.13.0.0.md) released Jan/14/2019
