...
### Send 25000 SPARKS to New Addresses

Send exactly 25000 SPARKS to each new address created above.
...
Copy the masternode private key and correspondig collateral output transaction that holds the 25000 SPARKS.

*Note: The masternode priviate key is **not** the same as a wallet private key. **Never** put your wallet private key in the masternode.conf file. That is almost equivalent to putting your 25000 SPARKS on the remote server and defeats the purpose of a hot/cold setup.*
...
[From the sparks github repo](https://github.com/sparkspayofficial/sparks/blob/master/doc/masternode_conf.md)
...
## Update sparks.conf on server

If you generated a new masternode private key, you will need to update the remote `sparks.conf` files.

Shut down the daemon and then edit the file.

```nano .sparkscore/sparks.conf```

### Edit the masternodeprivkey
If you generated a new masternode private key, you will need to update the `masternodeprivkey` value in your remote `sparks.conf` file.
...
and comparing with the official explorer at https://explorer.sparkspay.io/chain/Sparks
...
Search your Masternodes on https://sparksninja.pl/masternodes.html
