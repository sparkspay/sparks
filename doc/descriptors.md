# Support for Output Descriptors in Sparks Core

Since Sparks Core v0.17, there is support for Output Descriptors. This is a
...
existing Sparks Core wallets, a convenience function `combo` is
...
All RPCs in Sparks Core will include the checksum in their output. Only
