...
* sparks.conf: contains configuration settings for sparksd or sparks-qt
* sparksd.pid: stores the process id of sparksd while running
...
* debug.log: contains debug information and general logging generated by sparksd or sparks-qt
