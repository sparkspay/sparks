...
See the [Transifex Dash project](https://www.transifex.com/projects/p/sparks/) to assist in translations. You should also join the translation mailing list for announcements - see details below.
...
`contrib/sparks-qt.pro` takes care of generating `.qm` (binary compiled) files from `.ts` (source files) files. It’s mostly automated, and you shouldn’t need to worry about it.
...
You can find the Dash translation project at [https://www.transifex.com/projects/p/sparks/](https://www.transifex.com/projects/p/sparks/).
