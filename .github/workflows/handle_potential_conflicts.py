...
def main():
    ...
    for conflict in conflictPrs:
        ...
        r = requests.get(f'https://api.github.com/repos/sparkspay/sparks/pulls/{this_pr_num}')
        ...
        r = requests.get(f'https://github.com/sparkspay/sparks/branches/pre_mergeable/{our_pr_label}...{get_label(this_pr_num)}')
