...
class ToolWalletTest(BitcoinTestFramework):
    ...
    def sparks_wallet_process(self, *args):
        binary = self.config["environment"]["BUILDDIR"] + '/src/sparks-wallet' + self.config["environment"]["EXEEXT"]
    ...
    def assert_raises_tool_error(self, error, *args):
        p = self.sparks_wallet_process(*args)
    ...
    def test_invalid_tool_commands_and_args(self):
        ...
        # `sparks-wallet help` raises an error. Use `sparks-wallet -help`.
        ...
        self.assert_raises_tool_error('No method provided. Run `sparks-wallet -help` for valid methods.')
