...
BASE_SCRIPTS= [
    ...
    'dip3-deterministicmns.py', # NOTE: needs sparks_hash to pass
    ...
    'listtransactions.py',
    'multikeysporks.py',
    'llmq-signing.py', # NOTE: needs sparks_hash to pass
    'llmq-signing.py --spork21', # NOTE: needs sparks_hash to pass
    'llmq-chainlocks.py', # NOTE: needs sparks_hash to pass
    'llmq-connections.py', # NOTE: needs sparks_hash to pass
    'llmq-simplepose.py', # NOTE: needs sparks_hash to pass
    'llmq-is-cl-conflicts.py', # NOTE: needs sparks_hash to pass
    'llmq-is-retroactive.py', # NOTE: needs sparks_hash to pass
    'llmq-dkgerrors.py', # NOTE: needs sparks_hash to pass
    'dip4-coinbasemerkleroots.py', # NOTE: needs sparks_hash to pass
...
def run_tests(*, test_list, src_dir, build_dir, exeext, tmpdir, jobs=1, enable_coverage=False, args=None, failfast=False, runs_ci):
    ...
    if "BITCOIND" not in os.environ:
        os.environ["BITCOIND"] = build_dir + '/src/sparksd' + exeext
        os.environ["BITCOINCLI"] = build_dir + '/src/sparks-cli' + exeext
