...
from test_framework.test_framework import (
     SparksTestFramework, skip_if_no_bitcoind_zmq, skip_if_no_py3_zmq)
...
class SparksZMQTest (SparksTestFramework):
    def set_test_params(self):
        ...
        self.set_sparks_test_params(4, 3, fast_dip3_enforcement=True, extra_args=[node0_extra_args, [], [], []])

    def run_test(self):
        # Check that sparksd has been built with ZMQ enabled.
