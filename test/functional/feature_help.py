...
"""Verify that starting sparksd with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start sparksd with -h for help text")
        ...
        self.log.info("Start sparksd with -version for version information")
        ...
        self.log.info("Start sparksdd with -fakearg to make sure it does not start")
